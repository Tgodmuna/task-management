  ...
  return (
    <tbody>
      {tasks.map((task) => (
        <tr
          key={task?._id}
          className="border-t z-10 hover:bg-gray-50">
          ...
          <td className="p-3 relative">
            ...
            {openDropdown === task?._id && (
              <div className="absolute right-0 h-[10rem] mt-2 w-32 bg-gray-200 shadow-md rounded-md z-45">
                <button
                  ref={editContentRef}
                ...
                <select
                  ...
                  className="w-full px-4 py-2 hover:bg-gray-300 cursor-pointer">
